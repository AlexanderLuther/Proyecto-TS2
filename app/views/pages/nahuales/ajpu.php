<div>
  <h3 class="section-title" style="  color: #2dc997;">AJPU <?php if (isset($_GET['nivel']) && $_GET['nahual'] == "ajpu") {
    echo "Nivel ". $_GET['nivel'];
  } ?></h3>
  <img src="<?php echo URL_PATH ?>/img/nahuales/ajpu.jpg" height="90" width="90">
  <hr>
  <p>
