<div>
  <h3 class="section-title" style="  color: #2dc997;">AJ <?php if (isset($_GET['level']) && $_GET['nahual'] == "aj") {
    echo "Nivel ". $_GET['level'];
  } ?></h3>
  <img src="<?php echo URL_PATH ?>/img/nahuales/aj.jpg" height="90" width="90">
  <hr> 
  <p>
