<div>
  <h3 class="section-title" style="  color: #2dc997;">Aqabal <?php if (isset($_GET['nivel']) && $_GET['nahual'] == "aqabal") {
    echo "Nivel ". $_GET['nivel'];
  } ?></h3>
  <img src="<?php echo URL_PATH ?>/img/nahuales/aqabal.jpg" height="90" width="90">
  <hr>
  <p>
